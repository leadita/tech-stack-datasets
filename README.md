...
### Payments
- [Companies using Stripe](./leads/companies-using-stripe) (70,947 companies)
- [Companies using PayPal](./leads/companies-using-paypal) (67,670 companies)
...
- [Companies using Authorize.net](./leads/companies-using-authorize.net) (114,706 companies)
...
### Advertising
- [Companies using Google Adsense](./leads/companies-using-google-adsense) (92,366 companies)
...
### Analytics
- [Companies using Google Analytics](./leads/companies-using-google-analytics) (2,758,680 companies)
...
- [Companies using Matomo](./leads/companies-using-matomo) (45,057 companies)
- [Companies using CrazyEgg](./leads/companies-using-crazyegg) (8,886 companies)

### Artificial Intelligence
- [Companies using OpenAI](./leads/companies-using-openai) (7,425 companies)
...
- [Companies using PHP](./leads/companies-using-php) (2,764,923 companies)
...
- [Companies using Express](./leads/companies-using-express) (3,207,966 companies)
...
### Cloud Providers
- [Companies using Amazon](./leads/companies-using-amazon) (2,252,107 companies)
- [Companies using Google Cloud](./leads/companies-using-google-cloud) (4,982,001 companies)
...
- [Companies using Vercel](./leads/companies-using-vercel) (324,758 companies)
...
- [Companies using WordPress](./leads/companies-using-wordpress) (4,114,122 companies)
...
- [Companies using Webflow](./leads/companies-using-webflow) (46,688 companies)
- [Companies using Squarespace](./leads/companies-using-squarespace) (1,157,582 companies)
- [Companies using Wix](./leads/companies-using-wix) (1,239,000 companies)
...
- [Companies using Zoom](./leads/companies-using-zoom) (15,964 companies)
- [Companies using Discord](./leads/companies-using-discord) (12,494 companies)
- [Companies using Google Workspace](./leads/companies-using-google-workspace) (15,865 companies)
...
- [Companies using Telegram](./leads/companies-using-telegram) (101,865 companies)
...
- [Companies using Cloudflare](./leads/companies-using-cloudflare) (2,343,390 companies)
- [Companies using Akamai](./leads/companies-using-akamai) (6,466 companies)
- [Companies using Fastly](./leads/companies-using-fastly) (1,793,480 companies)
- [Companies using Amazon CloudFront](./leads/companies-using-amazon-cloudfront) (485,989 companies)
- [Companies using Cloudinary](./leads/companies-using-cloudinary) (39,794 companies)
- [Companies using StackPath](./leads/companies-using-stackpath) (60,106 companies)
...
- [Companies using jsDelivr](./leads/companies-using-jsdelivr) (591,122 companies)
- [Companies using CacheFly](./leads/companies-using-cachefly) (178 companies)

### Conversion Tracking & Retargeting
- [Companies using Facebook Pixel](./leads/companies-using-facebook-pixel) (405,624 companies)
...
- [Companies using PixelYourSite](./leads/companies-using-pixelyoursite) (22,413 companies)
- [Companies using Zemanta](./leads/companies-using-zemanta) (383 companies)

### Customer Relationship Management (CRM)
- [Companies using Salesforce](./leads/companies-using-salesforce) (14,061 companies)
- [Companies using Hubspot](./leads/companies-using-hubspot) (90,416 companies)
...
### CSS Frameworks
- [Companies using Tailwind CSS](./leads/companies-using-tailwind-css) (2,273,311 companies)
...
- [Companies using Bulma](./leads/companies-using-bulma) (324,595 companies)
- [Companies using Foundation](./leads/companies-using-foundation) (16,162 companies)
- [Companies using Semantic UI](./leads/companies-using-semantic-ui) (1,039 companies)
- [Companies using Styled Components](./leads/companies-using-styled-components) (38,208 companies)
- [Companies using Radix UI](./leads/companies-using-radix-ui) (37,951 companies)
...
- [Companies using reCAPTCHA](./leads/companies-using-recaptcha) (1,064,446 companies)
- [Companies using hCaptcha](./leads/companies-using-hcaptcha) (357,309 companies)
...
- [Companies using Magento](./leads/companies-using-magento) (862,069 companies)
...
- [Companies using GetResponse](./leads/companies-using-getresponse) (68,577 companies)
...
- [Companies using WPForms](./leads/companies-using-wpforms) (184,211 companies)
- [Companies using Gravity Forms](./leads/companies-using-gravity-forms) (195,090 companies)
...
- [Companies using Angular](./leads/companies-using-angular) (53,948 companies)
- [Companies using Next.js](./leads/companies-using-next.js) (459,520 companies)
- [Companies using Nuxt.js](./leads/companies-using-nuxt.js) (145,564 companies)
- [Companies using jQuery](./leads/companies-using-jquery) (2,984,855 companies)
...
- [Companies using GoFundMe](./leads/companies-using-gofundme) (5,271 companies)

### Performance Optimization
- [Companies using EWWW Image Optimizer](./leads/companies-using-ewww-image-optimizer) (15,600 companies)
- [Companies using Smush Image Optimization](./leads/companies-using-smush-image-optimization) (36,485 companies)
- [Companies using LiteSpeed](./leads/companies-using-litespeed) (1,057,900 companies)

### Popups & Modals
- [Companies using Elfsight](./leads/companies-using-elfsight) (74,900 companies)
...
### Video Platforms
- [Companies using YouTube](./leads/companies-using-youtube) (1,859,237 companies)
- [Companies using Vimeo](./leads/companies-using-vimeo) (238,254 companies)
...
### Web Fonts & Icons
- [Companies using Google Font API](./leads/companies-using-google-font-api) (4,555,037 companies)
- [Companies using Font Awesome](./leads/companies-using-font-awesome) (767,573 companies)
...
- [Companies using Fontello](./leads/companies-using-fontello) (41,783 companies)
- [Companies using IcoMoon](./leads/companies-using-icomoon) (1,275,182 companies)
- [Companies using Material Design Icons](./leads/companies-using-material-design-icons) (23,479 companies)

### Web Servers
- [Companies using NGINX](./leads/companies-using-nginx) (1,363,416 companies)
- [Companies using Apache](./leads/companies-using-apache) (1,352,931 companies)
- [Companies using LiteSpeed](./leads/companies-using-litespeed) (1,057,900 companies)
- [Companies using OpenResty](./leads/companies-using-openresty) (222,483 companies)
