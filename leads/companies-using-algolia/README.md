...
This folder contains an active list of 2,164 companies using **Algolia**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,164+** companies using Algolia.
