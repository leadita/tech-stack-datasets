...
This folder contains an active list of 484,137 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **484,137+** companies using Amazon CloudFront.
