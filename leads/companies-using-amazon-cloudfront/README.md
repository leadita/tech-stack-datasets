...
This folder contains an active list of 432,934 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **432,934+** companies using Amazon CloudFront.
