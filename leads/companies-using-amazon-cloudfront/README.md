...
This folder contains an active list of 491,132 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **491,132+** companies using Amazon CloudFront.
