...
This folder contains an active list of 486,005 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **486,005+** companies using Amazon CloudFront.
