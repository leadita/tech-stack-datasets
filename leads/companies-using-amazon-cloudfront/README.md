...
This folder contains an active list of 452,332 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **452,332+** companies using Amazon CloudFront.
