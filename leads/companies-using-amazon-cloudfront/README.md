...
This folder contains an active list of 444,081 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **444,081+** companies using Amazon CloudFront.
