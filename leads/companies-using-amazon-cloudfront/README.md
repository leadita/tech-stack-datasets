...
This folder contains an active list of 480,096 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **480,096+** companies using Amazon CloudFront.
