...
This folder contains an active list of 429,918 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **429,918+** companies using Amazon CloudFront.
