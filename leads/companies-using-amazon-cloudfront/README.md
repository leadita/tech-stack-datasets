...
This folder contains an active list of 515,292 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **515,292+** companies using Amazon CloudFront.
