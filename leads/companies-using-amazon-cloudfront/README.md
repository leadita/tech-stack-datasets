...
This folder contains an active list of 428,570 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **428,570+** companies using Amazon CloudFront.
