...
This folder contains an active list of 492,080 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **492,080+** companies using Amazon CloudFront.
