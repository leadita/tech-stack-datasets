...
This folder contains an active list of 495,881 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **495,881+** companies using Amazon CloudFront.
