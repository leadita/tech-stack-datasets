...
This folder contains an active list of 498,923 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **498,923+** companies using Amazon CloudFront.
