...
This folder contains an active list of 441,867 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **441,867+** companies using Amazon CloudFront.
