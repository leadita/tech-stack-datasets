...
This folder contains an active list of 447,325 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **447,325+** companies using Amazon CloudFront.
