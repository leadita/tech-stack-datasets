...
This folder contains an active list of 427,050 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **427,050+** companies using Amazon CloudFront.
