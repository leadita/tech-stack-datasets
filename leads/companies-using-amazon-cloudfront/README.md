...
This folder contains an active list of 500,246 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **500,246+** companies using Amazon CloudFront.
