...
This folder contains an active list of 445,539 companies using **Amazon CloudFront**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **445,539+** companies using Amazon CloudFront.
