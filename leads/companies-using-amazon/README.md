...
This folder contains an active list of 2,230,011 companies using **Amazon**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,230,011+** companies using Amazon.
