...
This folder contains an active list of 7,699 companies using **Amplitude**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **7,699+** companies using Amplitude.
