...
This folder contains an active list of 6,305 companies using **Amplitude**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **6,305+** companies using Amplitude.
