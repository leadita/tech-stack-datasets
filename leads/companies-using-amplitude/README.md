...
This folder contains an active list of 5,950 companies using **Amplitude**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **5,950+** companies using Amplitude.
