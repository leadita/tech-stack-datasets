...
This folder contains an active list of 54,817 companies using **Angular**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **54,817+** companies using Angular.
