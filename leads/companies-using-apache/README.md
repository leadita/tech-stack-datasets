...
This folder contains an active list of 1,423,057 companies using **Apache**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,423,057+** companies using Apache.
