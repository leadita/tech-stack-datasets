...
This folder contains an active list of 5,112 companies using **AppNexus**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **5,112+** companies using AppNexus.
