...
This folder contains an active list of 8,793 companies using **ASP.NET Core**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **8,793+** companies using ASP.NET Core.
