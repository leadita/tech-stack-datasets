...
This folder contains an active list of 10,284 companies using **ASP.NET Core**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **10,284+** companies using ASP.NET Core.
