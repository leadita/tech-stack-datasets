...
This folder contains an active list of 9,849 companies using **ASP.NET Core**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **9,849+** companies using ASP.NET Core.
