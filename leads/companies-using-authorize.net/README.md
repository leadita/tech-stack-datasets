...
This folder contains an active list of 124,761 companies using **Authorize.net**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **124,761+** companies using Authorize.net.
