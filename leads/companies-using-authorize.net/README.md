...
This folder contains an active list of 122,389 companies using **Authorize.net**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **122,389+** companies using Authorize.net.
