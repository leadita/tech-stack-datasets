...
This folder contains an active list of 117,058 companies using **Authorize.net**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **117,058+** companies using Authorize.net.
