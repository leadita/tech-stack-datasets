...
This folder contains an active list of 116,467 companies using **Authorize.net**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **116,467+** companies using Authorize.net.
