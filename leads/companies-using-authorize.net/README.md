...
This folder contains an active list of 121,733 companies using **Authorize.net**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **121,733+** companies using Authorize.net.
