...
This folder contains an active list of 115,913 companies using **Authorize.net**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **115,913+** companies using Authorize.net.
