...
This folder contains an active list of 163 companies using **Blackboard Open LMS**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **163+** companies using Blackboard Open LMS.
