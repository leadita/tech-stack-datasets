...
This folder contains an active list of 156 companies using **Blackboard Open LMS**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **156+** companies using Blackboard Open LMS.
