...
This folder contains an active list of 147 companies using **Blackboard Open LMS**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **147+** companies using Blackboard Open LMS.
