...
This folder contains an active list of 127 companies using **Blackboard Open LMS**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **127+** companies using Blackboard Open LMS.
