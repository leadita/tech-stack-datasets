...
This folder contains an active list of 142 companies using **Blackboard Open LMS**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **142+** companies using Blackboard Open LMS.
