...
This folder contains an active list of 3,951 companies using **Bookly**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,951+** companies using Bookly.
...
- **categories_uses**: Use cases for Bookly
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Bookly
