...
This folder contains an active list of 1,163 companies using **Breezy HR**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,163+** companies using Breezy HR.
