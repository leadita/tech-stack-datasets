...
This folder contains an active list of 792 companies using **Breezy HR**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **792+** companies using Breezy HR.
