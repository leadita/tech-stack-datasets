...
This folder contains an active list of 931 companies using **Breezy HR**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **931+** companies using Breezy HR.
