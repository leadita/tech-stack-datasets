...
This folder contains an active list of 910 companies using **Breezy HR**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **910+** companies using Breezy HR.
