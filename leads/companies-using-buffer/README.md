...
This folder contains an active list of 219 companies using **Buffer**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **219+** companies using Buffer.
