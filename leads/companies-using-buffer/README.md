...
This folder contains an active list of 217 companies using **Buffer**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **217+** companies using Buffer.
