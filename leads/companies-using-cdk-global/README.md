...
This folder contains an active list of 19 companies using **CDK Global**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **19+** companies using CDK Global.
...
- **categories_uses**: Use cases for CDK Global
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using CDK Global
