...
This folder contains an active list of 1,832 companies using **Chakra UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,832+** companies using Chakra UI.
...
- **categories_uses**: Use cases for Chakra UI
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Chakra UI
