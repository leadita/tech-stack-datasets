...
This folder contains an active list of 2,142 companies using **Chakra UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,142+** companies using Chakra UI.
