...
This folder contains an active list of 1,994 companies using **Chakra UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,994+** companies using Chakra UI.
