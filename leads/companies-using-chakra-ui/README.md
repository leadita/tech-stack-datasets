...
This folder contains an active list of 1,768 companies using **Chakra UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,768+** companies using Chakra UI.
