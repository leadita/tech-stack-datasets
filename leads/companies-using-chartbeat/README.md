...
This folder contains an active list of 380 companies using **Chartbeat**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **380+** companies using Chartbeat.
