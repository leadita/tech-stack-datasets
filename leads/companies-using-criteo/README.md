...
This folder contains an active list of 6,409 companies using **Criteo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **6,409+** companies using Criteo.
