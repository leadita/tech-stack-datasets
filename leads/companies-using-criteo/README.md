...
This folder contains an active list of 4,108 companies using **Criteo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **4,108+** companies using Criteo.
