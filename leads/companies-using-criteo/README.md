...
This folder contains an active list of 4,403 companies using **Criteo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **4,403+** companies using Criteo.
