...
This folder contains an active list of 5,858 companies using **Criteo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **5,858+** companies using Criteo.
