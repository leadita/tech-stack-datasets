...
This folder contains an active list of 5,041 companies using **Criteo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **5,041+** companies using Criteo.
