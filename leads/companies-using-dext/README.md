...
This folder contains an active list of 196 companies using **Dext**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **196+** companies using Dext.
