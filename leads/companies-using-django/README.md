...
This folder contains an active list of 574 companies using **Django**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **574+** companies using Django.
