...
This folder contains an active list of 598 companies using **Django**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **598+** companies using Django.
