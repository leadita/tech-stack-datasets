...
This folder contains an active list of 912 companies using **Django**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **912+** companies using Django.
