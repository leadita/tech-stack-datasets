...
This folder contains an active list of 832 companies using **Django**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **832+** companies using Django.
