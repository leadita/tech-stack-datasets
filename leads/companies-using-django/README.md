...
This folder contains an active list of 563 companies using **Django**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **563+** companies using Django.
