...
This folder contains an active list of 977 companies using **Django**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **977+** companies using Django.
