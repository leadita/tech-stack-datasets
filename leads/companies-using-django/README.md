...
This folder contains an active list of 760 companies using **Django**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **760+** companies using Django.
