...
This folder contains an active list of 2,765 companies using **Fontshare**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,765+** companies using Fontshare.
