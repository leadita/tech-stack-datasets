...
This folder contains an active list of 2,097 companies using **Fontshare**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,097+** companies using Fontshare.
