...
This folder contains an active list of 90 companies using **Freshteam**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **90+** companies using Freshteam.
