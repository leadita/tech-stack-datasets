...
This folder contains an active list of 1,547 companies using **Freshworks Bot**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,547+** companies using Freshworks Bot.
