...
This folder contains an active list of 3,061 companies using **Freshworks Bot**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,061+** companies using Freshworks Bot.
