...
This folder contains an active list of 4,084 companies using **Freshworks Bot**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **4,084+** companies using Freshworks Bot.
