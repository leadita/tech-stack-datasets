...
This folder contains an active list of 2,213 companies using **Freshworks Bot**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,213+** companies using Freshworks Bot.
