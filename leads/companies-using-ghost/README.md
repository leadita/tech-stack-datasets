...
This folder contains an active list of 701 companies using **Ghost**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **701+** companies using Ghost.
