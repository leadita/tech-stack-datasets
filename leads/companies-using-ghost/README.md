...
This folder contains an active list of 685 companies using **Ghost**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **685+** companies using Ghost.
