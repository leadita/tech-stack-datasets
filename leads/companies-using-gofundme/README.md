...
This folder contains an active list of 4,551 companies using **GoFundMe**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **4,551+** companies using GoFundMe.
