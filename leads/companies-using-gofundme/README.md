...
This folder contains an active list of 5,443 companies using **GoFundMe**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **5,443+** companies using GoFundMe.
