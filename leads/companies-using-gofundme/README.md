...
This folder contains an active list of 5,309 companies using **GoFundMe**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **5,309+** companies using GoFundMe.
