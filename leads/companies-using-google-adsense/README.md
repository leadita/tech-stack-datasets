...
This folder contains an active list of 93,712 companies using **Google Adsense**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **93,712+** companies using Google Adsense.
