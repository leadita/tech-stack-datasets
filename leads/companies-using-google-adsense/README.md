...
This folder contains an active list of 100,091 companies using **Google Adsense**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **100,091+** companies using Google Adsense.
