...
This folder contains an active list of 12,899 companies using **Google Workspace**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **12,899+** companies using Google Workspace.
