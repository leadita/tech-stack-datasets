...
This folder contains an active list of 47 companies using **Growsurf**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **47+** companies using Growsurf.
...
- **categories_uses**: Use cases for Growsurf
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Growsurf
