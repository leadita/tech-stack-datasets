...
This folder contains an active list of 16 companies using **Guidewire**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **16+** companies using Guidewire.
