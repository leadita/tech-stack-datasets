...
This folder contains an active list of 798 companies using **Gusto**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **798+** companies using Gusto.
...
- **categories_uses**: Use cases for Gusto
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Gusto
