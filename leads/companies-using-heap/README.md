...
This folder contains an active list of 2,461 companies using **Heap**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,461+** companies using Heap.
