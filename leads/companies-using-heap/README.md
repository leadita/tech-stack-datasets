...
This folder contains an active list of 2,349 companies using **Heap**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,349+** companies using Heap.
