...
This folder contains an active list of 1,976 companies using **Heap**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,976+** companies using Heap.
