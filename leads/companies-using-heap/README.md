...
This folder contains an active list of 1,965 companies using **Heap**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,965+** companies using Heap.
