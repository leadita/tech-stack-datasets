...
This folder contains an active list of 1,333 companies using **Hello Bar**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,333+** companies using Hello Bar.
...
- **categories_uses**: Use cases for Hello Bar
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Hello Bar
