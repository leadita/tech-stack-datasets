...
This folder contains an active list of 36,728 companies using **Heroku**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **36,728+** companies using Heroku.
