...
This folder contains an active list of 42,610 companies using **Heroku**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **42,610+** companies using Heroku.
