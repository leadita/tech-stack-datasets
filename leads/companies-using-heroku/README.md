...
This folder contains an active list of 44,621 companies using **Heroku**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **44,621+** companies using Heroku.
