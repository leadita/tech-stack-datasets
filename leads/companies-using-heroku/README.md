...
This folder contains an active list of 41,724 companies using **Heroku**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **41,724+** companies using Heroku.
