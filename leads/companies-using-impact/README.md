...
This folder contains an active list of 3,504 companies using **Impact**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,504+** companies using Impact.
