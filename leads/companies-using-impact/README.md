...
This folder contains an active list of 2,985 companies using **Impact**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,985+** companies using Impact.
