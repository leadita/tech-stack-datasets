...
This folder contains an active list of 17,624 companies using **Intercom**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **17,624+** companies using Intercom.
