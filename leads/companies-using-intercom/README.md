...
This folder contains an active list of 19,315 companies using **Intercom**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **19,315+** companies using Intercom.
