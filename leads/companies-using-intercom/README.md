...
This folder contains an active list of 20,864 companies using **Intercom**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **20,864+** companies using Intercom.
