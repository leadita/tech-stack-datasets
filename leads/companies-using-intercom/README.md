...
This folder contains an active list of 21,177 companies using **Intercom**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **21,177+** companies using Intercom.
