...
This folder contains an active list of 20,761 companies using **Intercom**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **20,761+** companies using Intercom.
