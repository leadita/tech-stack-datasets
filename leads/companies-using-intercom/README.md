...
This folder contains an active list of 14,644 companies using **Intercom**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **14,644+** companies using Intercom.
