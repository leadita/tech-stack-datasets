...
This folder contains an active list of 606 companies using **Iterable**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **606+** companies using Iterable.
