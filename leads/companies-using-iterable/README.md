...
This folder contains an active list of 573 companies using **Iterable**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **573+** companies using Iterable.
