...
This folder contains an active list of 242 companies using **Jane App**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **242+** companies using Jane App.
