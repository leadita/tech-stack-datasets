...
This folder contains an active list of 150 companies using **Jane App**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **150+** companies using Jane App.
