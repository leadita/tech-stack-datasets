...
This folder contains an active list of 119 companies using **Jane App**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **119+** companies using Jane App.
