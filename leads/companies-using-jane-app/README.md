...
This folder contains an active list of 96 companies using **Jane App**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **96+** companies using Jane App.
