...
This folder contains an active list of 1,703 companies using **JIRA**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,703+** companies using JIRA.
