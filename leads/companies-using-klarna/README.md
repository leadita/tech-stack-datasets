...
This folder contains an active list of 4,880 companies using **Klarna**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **4,880+** companies using Klarna.
