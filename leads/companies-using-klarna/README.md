...
This folder contains an active list of 5,096 companies using **Klarna**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **5,096+** companies using Klarna.
