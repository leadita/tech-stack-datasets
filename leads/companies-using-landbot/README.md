...
This folder contains an active list of 526 companies using **LandBot**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **526+** companies using LandBot.
...
- **categories_uses**: Use cases for LandBot
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using LandBot
