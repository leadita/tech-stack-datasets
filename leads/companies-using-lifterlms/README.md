...
This folder contains an active list of 487 companies using **LifterLMS**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **487+** companies using LifterLMS.
...
- **categories_uses**: Use cases for LifterLMS
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using LifterLMS
