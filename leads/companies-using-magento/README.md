...
This folder contains an active list of 661,207 companies using **Magento**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **661,207+** companies using Magento.
