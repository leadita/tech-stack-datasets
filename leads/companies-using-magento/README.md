...
This folder contains an active list of 826,820 companies using **Magento**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **826,820+** companies using Magento.
