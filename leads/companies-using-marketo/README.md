...
This folder contains an active list of 1,154 companies using **Marketo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,154+** companies using Marketo.
