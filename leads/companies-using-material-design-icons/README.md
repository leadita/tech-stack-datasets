...
This folder contains an active list of 23,287 companies using **Material Design Icons**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **23,287+** companies using Material Design Icons.
