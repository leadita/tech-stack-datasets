...
This folder contains an active list of 23,435 companies using **Material Design Icons**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **23,435+** companies using Material Design Icons.
