...
This folder contains an active list of 25,392 companies using **Material Design Icons**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **25,392+** companies using Material Design Icons.
