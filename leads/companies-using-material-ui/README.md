...
This folder contains an active list of 23,054 companies using **Material-UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **23,054+** companies using Material-UI.
