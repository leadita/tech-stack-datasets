...
This folder contains an active list of 20,697 companies using **Material-UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **20,697+** companies using Material-UI.
