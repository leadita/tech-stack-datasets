...
This folder contains an active list of 19,905 companies using **Material-UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **19,905+** companies using Material-UI.
