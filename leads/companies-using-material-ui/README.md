...
This folder contains an active list of 21,531 companies using **Material-UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **21,531+** companies using Material-UI.
