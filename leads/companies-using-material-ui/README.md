...
This folder contains an active list of 24,002 companies using **Material-UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **24,002+** companies using Material-UI.
