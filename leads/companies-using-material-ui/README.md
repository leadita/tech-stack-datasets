...
This folder contains an active list of 22,798 companies using **Material-UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **22,798+** companies using Material-UI.
