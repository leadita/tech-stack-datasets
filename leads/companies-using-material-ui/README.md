...
This folder contains an active list of 18,674 companies using **Material-UI**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **18,674+** companies using Material-UI.
