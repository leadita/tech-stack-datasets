...
This folder contains an active list of 31,725 companies using **Medium**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **31,725+** companies using Medium.
