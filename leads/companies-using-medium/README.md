...
This folder contains an active list of 28,317 companies using **Medium**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **28,317+** companies using Medium.
