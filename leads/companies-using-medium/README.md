...
This folder contains an active list of 30,280 companies using **Medium**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **30,280+** companies using Medium.
