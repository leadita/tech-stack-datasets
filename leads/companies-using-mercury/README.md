...
This folder contains an active list of 312 companies using **Mercury**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **312+** companies using Mercury.
