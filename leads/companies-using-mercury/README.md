...
This folder contains an active list of 327 companies using **Mercury**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **327+** companies using Mercury.
