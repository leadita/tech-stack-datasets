...
This folder contains an active list of 352 companies using **Mercury**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **352+** companies using Mercury.
