...
This folder contains an active list of 316 companies using **Mercury**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **316+** companies using Mercury.
