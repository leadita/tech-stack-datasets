...
This folder contains an active list of 3,518 companies using **Monday.com**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,518+** companies using Monday.com.
