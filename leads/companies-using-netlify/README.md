...
This folder contains an active list of 98,745 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **98,745+** companies using Netlify.
