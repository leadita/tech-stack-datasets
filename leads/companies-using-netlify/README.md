...
This folder contains an active list of 130,236 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **130,236+** companies using Netlify.
