...
This folder contains an active list of 131,130 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **131,130+** companies using Netlify.
