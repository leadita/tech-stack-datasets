...
This folder contains an active list of 96,440 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **96,440+** companies using Netlify.
