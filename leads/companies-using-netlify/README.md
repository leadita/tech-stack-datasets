...
This folder contains an active list of 97,811 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **97,811+** companies using Netlify.
