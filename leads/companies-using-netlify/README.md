...
This folder contains an active list of 130,847 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **130,847+** companies using Netlify.
