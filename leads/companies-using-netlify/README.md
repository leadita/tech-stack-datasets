...
This folder contains an active list of 124,094 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **124,094+** companies using Netlify.
