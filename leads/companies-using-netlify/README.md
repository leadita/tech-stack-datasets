...
This folder contains an active list of 99,166 companies using **Netlify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **99,166+** companies using Netlify.
