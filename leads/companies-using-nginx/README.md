...
This folder contains an active list of 1,319,499 companies using **NGINX**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,319,499+** companies using NGINX.
