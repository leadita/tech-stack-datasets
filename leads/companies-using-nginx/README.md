...
This folder contains an active list of 1,467,409 companies using **NGINX**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,467,409+** companies using NGINX.
