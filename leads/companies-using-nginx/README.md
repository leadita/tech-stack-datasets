...
This folder contains an active list of 1,322,695 companies using **NGINX**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,322,695+** companies using NGINX.
