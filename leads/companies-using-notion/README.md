...
This folder contains an active list of 2,775 companies using **Notion**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,775+** companies using Notion.
