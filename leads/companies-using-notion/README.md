...
This folder contains an active list of 3,391 companies using **Notion**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,391+** companies using Notion.
