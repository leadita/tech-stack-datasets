...
This folder contains an active list of 2,954 companies using **Notion**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,954+** companies using Notion.
