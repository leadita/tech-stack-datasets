...
This folder contains an active list of 2,812 companies using **Notion**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,812+** companies using Notion.
...
- **categories_uses**: Use cases for Notion
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Notion
