...
This folder contains an active list of 518 companies using **Okta**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **518+** companies using Okta.
