...
This folder contains an active list of 448 companies using **Okta**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **448+** companies using Okta.
