...
This folder contains an active list of 545 companies using **Okta**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **545+** companies using Okta.
