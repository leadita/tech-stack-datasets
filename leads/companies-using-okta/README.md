...
This folder contains an active list of 444 companies using **Okta**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **444+** companies using Okta.
