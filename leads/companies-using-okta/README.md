...
This folder contains an active list of 524 companies using **Okta**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **524+** companies using Okta.
