...
This folder contains an active list of 416 companies using **Okta**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **416+** companies using Okta.
