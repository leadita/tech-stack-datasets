...
This folder contains an active list of 307,653 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **307,653+** companies using OpenResty.
