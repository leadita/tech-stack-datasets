...
This folder contains an active list of 268,160 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **268,160+** companies using OpenResty.
