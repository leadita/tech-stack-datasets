...
This folder contains an active list of 269,777 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **269,777+** companies using OpenResty.
