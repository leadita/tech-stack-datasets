...
This folder contains an active list of 304,665 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **304,665+** companies using OpenResty.
