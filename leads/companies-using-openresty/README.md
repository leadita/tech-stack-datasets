...
This folder contains an active list of 272,421 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **272,421+** companies using OpenResty.
