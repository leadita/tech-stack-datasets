...
This folder contains an active list of 308,013 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **308,013+** companies using OpenResty.
