...
This folder contains an active list of 309,434 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **309,434+** companies using OpenResty.
