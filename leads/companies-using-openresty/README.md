...
This folder contains an active list of 319,099 companies using **OpenResty**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **319,099+** companies using OpenResty.
