...
This folder contains an active list of 185 companies using **Optimal Blue**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **185+** companies using Optimal Blue.
