...
This folder contains an active list of 225 companies using **Optimal Blue**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **225+** companies using Optimal Blue.
