...
This folder contains an active list of 218 companies using **Optimal Blue**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **218+** companies using Optimal Blue.
