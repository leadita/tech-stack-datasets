...
This folder contains an active list of 183 companies using **Optimal Blue**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **183+** companies using Optimal Blue.
