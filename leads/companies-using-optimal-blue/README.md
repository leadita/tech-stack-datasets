...
This folder contains an active list of 202 companies using **Optimal Blue**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **202+** companies using Optimal Blue.
