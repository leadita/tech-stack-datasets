...
This folder contains an active list of 166 companies using **Optimal Blue**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **166+** companies using Optimal Blue.
...
- **categories_uses**: Use cases for Optimal Blue
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Optimal Blue
