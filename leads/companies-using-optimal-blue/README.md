...
This folder contains an active list of 163 companies using **Optimal Blue**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **163+** companies using Optimal Blue.
