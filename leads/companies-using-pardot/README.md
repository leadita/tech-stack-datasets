...
This folder contains an active list of 2,621 companies using **Pardot**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,621+** companies using Pardot.
