...
This folder contains an active list of 2,787 companies using **Pardot**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,787+** companies using Pardot.
