...
This folder contains an active list of 70,095 companies using **PayPal**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **70,095+** companies using PayPal.
