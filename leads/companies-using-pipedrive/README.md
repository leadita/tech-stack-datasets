...
This folder contains an active list of 2,133 companies using **Pipedrive**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,133+** companies using Pipedrive.
