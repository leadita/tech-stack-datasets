...
This folder contains an active list of 11,964 companies using **PrestaShop**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **11,964+** companies using PrestaShop.
