...
This folder contains an active list of 10,927 companies using **PrestaShop**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **10,927+** companies using PrestaShop.
