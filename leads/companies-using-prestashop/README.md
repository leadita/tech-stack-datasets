...
This folder contains an active list of 11,746 companies using **PrestaShop**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **11,746+** companies using PrestaShop.
