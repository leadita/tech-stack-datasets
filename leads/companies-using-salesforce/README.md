...
This folder contains an active list of 14,487 companies using **Salesforce**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **14,487+** companies using Salesforce.
