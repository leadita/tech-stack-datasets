...
This folder contains an active list of 12,413 companies using **Salesforce**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **12,413+** companies using Salesforce.
