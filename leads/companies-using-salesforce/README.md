...
This folder contains an active list of 14,538 companies using **Salesforce**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **14,538+** companies using Salesforce.
