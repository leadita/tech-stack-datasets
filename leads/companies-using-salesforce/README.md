...
This folder contains an active list of 15,002 companies using **Salesforce**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **15,002+** companies using Salesforce.
