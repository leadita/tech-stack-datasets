...
This folder contains an active list of 13,120 companies using **Salesforce**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **13,120+** companies using Salesforce.
