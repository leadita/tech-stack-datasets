...
This folder contains an active list of 13,490 companies using **Salesforce**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **13,490+** companies using Salesforce.
