...
This folder contains an active list of 12,819 companies using **Salesforce**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **12,819+** companies using Salesforce.
