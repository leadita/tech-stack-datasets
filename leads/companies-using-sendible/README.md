...
This folder contains an active list of 8 companies using **Sendible**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **8+** companies using Sendible.
