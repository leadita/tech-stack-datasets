...
This folder contains an active list of 7 companies using **Sendible**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **7+** companies using Sendible.
