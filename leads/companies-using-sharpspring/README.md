...
This folder contains an active list of 128 companies using **SharpSpring**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **128+** companies using SharpSpring.
