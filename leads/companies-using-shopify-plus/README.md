...
This folder contains an active list of 2,227 companies using **Shopify Plus**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,227+** companies using Shopify Plus.
...
- **categories_uses**: Use cases for Shopify Plus
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Shopify Plus
