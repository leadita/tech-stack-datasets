...
This folder contains an active list of 376,852 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **376,852+** companies using Shopify.
