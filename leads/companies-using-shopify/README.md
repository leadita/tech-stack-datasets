...
This folder contains an active list of 388,933 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **388,933+** companies using Shopify.
