...
This folder contains an active list of 378,958 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **378,958+** companies using Shopify.
