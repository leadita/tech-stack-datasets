...
This folder contains an active list of 332,503 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **332,503+** companies using Shopify.
