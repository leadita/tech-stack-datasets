...
This folder contains an active list of 330,121 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **330,121+** companies using Shopify.
