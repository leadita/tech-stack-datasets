...
This folder contains an active list of 329,400 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **329,400+** companies using Shopify.
