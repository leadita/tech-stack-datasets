...
This folder contains an active list of 327,293 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **327,293+** companies using Shopify.
