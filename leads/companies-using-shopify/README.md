...
This folder contains an active list of 367,607 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **367,607+** companies using Shopify.
