...
This folder contains an active list of 378,207 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **378,207+** companies using Shopify.
