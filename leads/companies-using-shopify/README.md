...
This folder contains an active list of 336,801 companies using **Shopify**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **336,801+** companies using Shopify.
