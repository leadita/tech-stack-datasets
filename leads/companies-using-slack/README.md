...
This folder contains an active list of 3,998 companies using **Slack**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,998+** companies using Slack.
