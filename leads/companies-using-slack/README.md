...
This folder contains an active list of 3,768 companies using **Slack**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,768+** companies using Slack.
...
- **categories_uses**: Use cases for Slack
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Slack
