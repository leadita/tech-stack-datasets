...
This folder contains an active list of 4,289 companies using **Slack**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **4,289+** companies using Slack.
