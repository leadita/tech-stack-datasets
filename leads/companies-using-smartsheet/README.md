...
This folder contains an active list of 521 companies using **Smartsheet**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **521+** companies using Smartsheet.
