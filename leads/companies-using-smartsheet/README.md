...
This folder contains an active list of 511 companies using **Smartsheet**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **511+** companies using Smartsheet.
