...
This folder contains an active list of 580 companies using **Smartsheet**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **580+** companies using Smartsheet.
