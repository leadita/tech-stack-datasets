...
This folder contains an active list of 530 companies using **Smartsheet**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **530+** companies using Smartsheet.
