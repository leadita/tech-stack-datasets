...
This folder contains an active list of 638 companies using **Smartsheet**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **638+** companies using Smartsheet.
