...
This folder contains an active list of 546 companies using **Smartsheet**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **546+** companies using Smartsheet.
