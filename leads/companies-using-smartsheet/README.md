...
This folder contains an active list of 619 companies using **Smartsheet**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **619+** companies using Smartsheet.
