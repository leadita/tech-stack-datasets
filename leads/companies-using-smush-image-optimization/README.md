...
This folder contains an active list of 35,137 companies using **Smush Image Optimization**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **35,137+** companies using Smush Image Optimization.
