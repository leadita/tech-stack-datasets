...
This folder contains an active list of 37,015 companies using **Smush Image Optimization**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **37,015+** companies using Smush Image Optimization.
