...
This folder contains an active list of 36,004 companies using **Smush Image Optimization**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **36,004+** companies using Smush Image Optimization.
