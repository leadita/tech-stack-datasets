...
This folder contains an active list of 39,015 companies using **Smush Image Optimization**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **39,015+** companies using Smush Image Optimization.
