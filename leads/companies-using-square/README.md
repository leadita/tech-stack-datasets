...
This folder contains an active list of 30,548 companies using **Square**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **30,548+** companies using Square.
...
- **categories_uses**: Use cases for Square
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Square
