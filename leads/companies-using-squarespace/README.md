...
This folder contains an active list of 1,182,861 companies using **Squarespace**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,182,861+** companies using Squarespace.
