...
This folder contains an active list of 1,168,266 companies using **Squarespace**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,168,266+** companies using Squarespace.
