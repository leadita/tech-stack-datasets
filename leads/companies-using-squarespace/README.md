...
This folder contains an active list of 896,651 companies using **Squarespace**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **896,651+** companies using Squarespace.
