...
This folder contains an active list of 64,073 companies using **Stripe**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **64,073+** companies using Stripe.
