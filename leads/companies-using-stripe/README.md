...
This folder contains an active list of 69,432 companies using **Stripe**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **69,432+** companies using Stripe.
