...
This folder contains an active list of 68,008 companies using **Stripe**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **68,008+** companies using Stripe.
