...
This folder contains an active list of 950 companies using **Tableau**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **950+** companies using Tableau.
