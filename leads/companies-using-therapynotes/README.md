...
This folder contains an active list of 168 companies using **TherapyNotes**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **168+** companies using TherapyNotes.
...
- **categories_uses**: Use cases for TherapyNotes
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using TherapyNotes
