...
This folder contains an active list of 20,716 companies using **Tidio**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **20,716+** companies using Tidio.
