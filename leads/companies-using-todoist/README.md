...
This folder contains an active list of 60 companies using **Todoist**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **60+** companies using Todoist.
