...
This folder contains an active list of 61 companies using **Todoist**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **61+** companies using Todoist.
