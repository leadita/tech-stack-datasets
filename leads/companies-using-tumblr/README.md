...
This folder contains an active list of 43,812 companies using **Tumblr**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **43,812+** companies using Tumblr.
...
- **categories_uses**: Use cases for Tumblr
- **crawled_at**: Last detection date

## 💡 Use Cases
- **Sales Teams**: Find prospects using Tumblr
