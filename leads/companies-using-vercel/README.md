...
This folder contains an active list of 284,042 companies using **Vercel**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **284,042+** companies using Vercel.
