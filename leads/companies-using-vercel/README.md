...
This folder contains an active list of 209,932 companies using **Vercel**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **209,932+** companies using Vercel.
