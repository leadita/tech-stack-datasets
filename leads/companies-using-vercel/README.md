...
This folder contains an active list of 336,599 companies using **Vercel**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **336,599+** companies using Vercel.
