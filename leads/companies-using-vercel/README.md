...
This folder contains an active list of 215,081 companies using **Vercel**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **215,081+** companies using Vercel.
