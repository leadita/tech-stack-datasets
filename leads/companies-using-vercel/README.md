...
This folder contains an active list of 297,228 companies using **Vercel**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **297,228+** companies using Vercel.
