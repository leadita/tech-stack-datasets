...
This folder contains an active list of 253,422 companies using **Vimeo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **253,422+** companies using Vimeo.
