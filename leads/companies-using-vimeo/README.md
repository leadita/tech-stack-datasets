...
This folder contains an active list of 252,966 companies using **Vimeo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **252,966+** companies using Vimeo.
