...
This folder contains an active list of 253,385 companies using **Vimeo**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **253,385+** companies using Vimeo.
