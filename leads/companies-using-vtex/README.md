...
This folder contains an active list of 43 companies using **VTEX**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **43+** companies using VTEX.
