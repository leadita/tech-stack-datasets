...
This folder contains an active list of 55 companies using **VTEX**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **55+** companies using VTEX.
