...
This folder contains an active list of 58 companies using **VTEX**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **58+** companies using VTEX.
