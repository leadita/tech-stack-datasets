...
This folder contains an active list of 53 companies using **VTEX**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **53+** companies using VTEX.
