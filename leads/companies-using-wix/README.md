...
This folder contains an active list of 1,299,559 companies using **Wix**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,299,559+** companies using Wix.
