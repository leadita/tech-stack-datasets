...
This folder contains an active list of 990,993 companies using **Wix**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **990,993+** companies using Wix.
