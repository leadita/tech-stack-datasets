...
This folder contains an active list of 983,689 companies using **Wix**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **983,689+** companies using Wix.
