...
This folder contains an active list of 3,712,669 companies using **WordPress**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **3,712,669+** companies using WordPress.
