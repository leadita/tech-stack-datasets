...
This folder contains an active list of 1,172 companies using **Xero**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **1,172+** companies using Xero.
