...
This folder contains an active list of 68 companies using **Yardi**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **68+** companies using Yardi.
