...
This folder contains an active list of 2,744 companies using **ZocDoc**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **2,744+** companies using ZocDoc.
